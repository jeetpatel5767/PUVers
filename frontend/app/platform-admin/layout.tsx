...
const NAV_ITEMS = [
  ...
  { label: "Roles & Permissions", href: "/platform-admin/roles", icon: ShieldCheck },
  { label: "Users", href: "/platform-admin/users", icon: Users },
  { label: "Organizations", href: "/platform-admin/organizations", icon: Building2 },
  { label: "All Events", href: "/platform-admin/events", icon: CalendarDays },
      ...
      >
        ...
        <nav className="flex-1 px-4 py-5 space-y-1 overflow-y-auto">
          {NAV_ITEMS.map((item) => {
            ...
            const isExactDashboard = item.href === "/platform-admin" && pathname === "/platform-admin";
            ...
            return (
              ...
              >
                ...
                <span className="text-[0.78rem] font-medium flex-1">{item.label}</span>
        ...
        <div className="px-4 py-5">
          <div
            ...
            style={{ borderRadius: "14px", background: "hsl(0 0% 100% / 0.08)" }}
          >
            <Squircle
              cornerRadius={11}
              cornerSmoothing={1}
              ...
              style={{ background: "linear-gradient(135deg, var(--role-platform), hsl(0 50% 45%))" }}
            >
